import { RedBlackTree, RedBlackTreeNode, DoublyLinkedList } from "data-structure-typed";
import { LimitOrder, OrderSide, OrderBookRedBlackTree } from "./types";
import { OrderBookSide } from "./OrderBookSide";

type OrderBookRedBlackTreeNode = RedBlackTreeNode<number, DoublyLinkedList<LimitOrder>>;
export class RedBlackTreeOrderBookSide implements OrderBookSide<OrderBookRedBlackTree> {
  dataStructure: OrderBookRedBlackTree;
  orderSide: OrderSide;

  constructor(orderSide: OrderSide) {
    this.dataStructure = new RedBlackTree<number, DoublyLinkedList<LimitOrder>>();
  ...
  private getBestPriceNode = () => {
    let bestPriceNode: OrderBookRedBlackTreeNode | undefined;
